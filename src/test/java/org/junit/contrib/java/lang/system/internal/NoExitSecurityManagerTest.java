...
public class NoExitSecurityManagerTest {
	...
	public class ForManagerWithOriginalSecurityManager {
	...
	public class ForManagerWithoutOriginalSecurityManager {
	...
	public class RegardlessOfOriginalManager {
		private final NoExitSecurityManager anyNoExitSecurityManager = new NoExitSecurityManager(null);

		@Test
		public void provideInformationThatCheckExitHasNotBeenCalled() {
			assertThat(anyNoExitSecurityManager,
		...
		private void safeCallCheckExitWithStatus(int status) {
			try {
				anyNoExitSecurityManager.checkExit(status);
		...
		public void doesNotProvideStatusOfFirstCheckExitCallWithoutCall() {
			...
			anyNoExitSecurityManager.getStatusOfFirstCheckExitCall();
		}
	}
}
